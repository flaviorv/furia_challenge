        ...
        {allMessages.map((message) => {
          ...
          return (
            <article className="furia-chat-article" id={'furia-chat-article-' + senderType} key={message.id}>
              <p id="chat-message-sender" className="furia-chat-message">
                {message.sender}
              </p>
              <p id="chat-message-message" className="furia-chat-message">
                {message.message}
              </p>
              <p id="chat-message-timestamp" className="furia-chat-message">
